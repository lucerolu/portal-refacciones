//src\components\PresupuestosPanel.jsx
...
export default function PresupuestosPanel({ isOpen, onClose }) {
      ...
      <MultiLevelDrawer isOpen={isOpen} onClose={onClose}>
        <div className="bg-white rounded-2xl shadow p-4 flex h-[70vh] w-full overflow-x-auto">
          ...
          <div className="w-64 border-r p-4 flex flex-col gap-4">
            <h3 className="font-semibold">Categorías de presupuestos</h3>
          ...
          <div className="flex-1 p-4 flex flex-col">
            <h3 className="font-semibold mb-2">
              {activeSubmenu
                ...
                : "Selecciona una categoría de presupuestos"}
            </h3>
                    ...
                    <div className="flex justify-between items-center bg-gray-100 px-3 py-2 rounded-md mb-3">
                      ...
                      {selectedNode.url && (
                        <a
                          ...
                          className="bg-emerald-600 text-white text-xs px-3 py-1 rounded-md"
                        >
                          Abrir en Drive
                        </a>
                      )}

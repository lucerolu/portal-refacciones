//src\components\IneventariosPanel.jsx
...
export default function InventariosPanel({ isOpen, onClose }) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await fetch("/api/drive?seccion=inventarios");
      ...
      <MultiLevelDrawer isOpen={isOpen} onClose={onClose}>
        <div className="bg-white rounded-2xl shadow p-4 flex h-[75vh] w-full overflow-x-auto min-h-0">
          ...
          <div className="w-64 border-r p-4 flex flex-col gap-4">
            <h3 className="font-semibold">Categorías de control de inventarios</h3>
